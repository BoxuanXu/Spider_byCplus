...
#ifndef EASY_MYSQL_H_
#define EASY_MYSQL_H_
...
public:
    ...
    int Connect(const char* szDbIp, const char* szUser, const char* szPassword, const char* szDatabase);
